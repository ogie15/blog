                    ...
                    <div class="row" align="center">
                        <div class="col-md-12" align="center" >
                            <div class="panel" align="center">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h3>EDIT<small>Blog post</small></h3>
                                    </div>
                                </div>
                            ...
                            foreach($send->result_array() as $row){
                                echo(' 
                                    <form method="post" action="'.base_url().'admin_controller/Admin_controller/editpostdb" enctype="multipart/form-data" class="form-horizontal" align="center">

                                    	<div class="form-group">
                                    		<label for="text1" class="col-sm-2 control-label">POST TITLE</label>
                                    		<div class="col-sm-10">
                                    			<input type="text" name="title" class="form-control" id="text1" value="'.$row['post_title'].'" required/>
                                    		</div>
                                    	</div>
                                        <div class="form-group">
                                    		<label for="email2" class="col-sm-2 control-label">CONTENT</label>
                                    		<div class="col-sm-10 show">
                                    			<textarea name="main" rows="10" cols="100" required/>
                                                    '.$row['main_post'].'
                                                </textarea>
                                    		</div>
                                    	</div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="hidden" name="who" value="'.$row['who_made_post'].'">
