                            ...
                            <div class="panel" align="center">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h3>POST<small>Blog post</small></h3>
                                    </div>
                                </div>
                                <div class="panel-body" align="center">

                                    <form method="post" action="<?php echo (base_url());?>admin_controller/Admin_controller/addpostdb" enctype="multipart/form-data" class="form-horizontal" align="center">

                                    	<div class="form-group">
                                    		<label for="text1" class="col-sm-2 control-label">POST TITLE</label>
                                    		<div class="col-sm-10">
                                    			<input type="text" name="title" class="form-control" id="text1" placeholder="Input type text" required>
                                    		</div>
                                    	</div>
                                        <div class="form-group">
                                    		<label for="email2" class="col-sm-2 control-label">CONTENT</label>
                                    		<div class="col-sm-10">
                                    			<textarea name="message" rows="5" cols="30" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="hidden" name="admin_name" value="Okougbo E.">
                                            </div>
                                        </div>
                                    	<div class="form-group">
